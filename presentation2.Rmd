...
- In words: Open source R package from Rstudio that creates interactive web applications around your R code
- Allows users to interact with your data ..
- ... without knowlege of the R code required
...
<img src="img/shiny-runapp.png" height="160">
